...
public interface BibliothequeServices {
    ...
    public com.biblio.PretResponse addPret(
        ...
        boolean prolonger,
        @WebParam(name = "cloturationpret", targetNamespace = "")
        boolean cloturationpret
    );
    ...
    public com.biblio.DocumentResponse addDocument(
        @WebParam(name = "refbibliotheque", targetNamespace = "")
        int refbibliotheque,
        @WebParam(name = "nombibliotheque", targetNamespace = "")
        java.lang.String nombibliotheque,
        ...
        @WebParam(name = "rayon", targetNamespace = "")
        java.lang.String rayon,
    ...
    @WebMethod
    @Action(input = "http://biblio.com/BibliothequeServices/updatePretRequest", output = "http://biblio.com/BibliothequeServices/updatePretResponse")
    @RequestWrapper(localName = "updatePret", targetNamespace = "http://biblio.com/", className = "com.biblio.UpdatePret")
    @ResponseWrapper(localName = "updatePretResponse", targetNamespace = "http://biblio.com/", className = "com.biblio.UpdatePretResponse")
    @WebResult(name = "return", targetNamespace = "")
    public com.biblio.PretResponse updatePret(
        @WebParam(name = "dureepret", targetNamespace = "")
        java.lang.String dureepret,
        @WebParam(name = "prolonger", targetNamespace = "")
        boolean prolonger,
