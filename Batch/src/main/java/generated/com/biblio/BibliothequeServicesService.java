 ...
 * 2019-05-31T12:12:33.268+02:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "BibliothequeServicesService", 
                  wsdlLocation = "http://192.168.1.46:8084/bibliotheque/bibliothequeB?wsdl",
...
public class BibliothequeServicesService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.1.46:8084/bibliotheque/bibliothequeB?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BibliothequeServicesService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.1.46:8084/bibliotheque/bibliothequeB?wsdl");
        }
        WSDL_LOCATION = url;
    }
